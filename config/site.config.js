...
module.exports = {
  ...
  footer:
    'Made by SpencerWoo & bebestmaple.',

  // [OPTIONAL] This is where you specify the folders that are password protected. It is an array of paths pointing to all
  // the directories in which you have .password set. Check the documentation for details.
  protectedRoutes: (process.env.ProtectedRoutes ? process.env.ProtectedRoutes.split(','):[]).concat( ['/🌞 Private folder/u-need-a-password', '/🥟 Some test files/Protected route','/Private','/images']),
